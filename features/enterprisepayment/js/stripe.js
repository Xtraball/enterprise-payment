/*! stripe-js 09-11-2018 */
(function () {
    var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r = {}.hasOwnProperty, s = function (a, b) {
        function c() {
            this.constructor = a
        }
    ...
    if (o = "https://js.stripe.com", g = "https://js.stripe.com", i = !!/stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0), h = /MSIE 9/i.test(navigator.userAgent), f = "console" in window && "warn" in window.console, e = function () {
        var a;
        return (null != (a = window.performance) && "function" == typeof a.now ? a.now() : void 0) || ("function" == typeof Date.now ? Date.now() : void 0) || +new Date
    }, n = e(), l = {}, !i && "querySelectorAll" in document && f && (m = document.querySelectorAll('script[src^="' + o + '"]'), m.length || console.warn("It looks like Stripe.js is not being loaded from https://js.stripe.com. Stripe does not support serving Stripe.js from your own domain.")), a = function () {
        function a() {
        ...
        return a.version = 2, a.endpoint = "https://api.stripe.com/v1", a.StripeV3 = null, a.setPublishableKey = function (b) {
            var c, d;
            if (a.key = b, a.utils.validateProtocol(a.key), d = /^pk_test_/.test(a.key), h && d && !a.acknowledgeIE9Deprecation) throw c = "Starting in December 2018, stripe.js v2 and Checkout will no longer support IE9, per Microsoft's lifecycle policy\n\nThis error is being thrown only in IE9 in testmode so that you have an opportunity to update your integration or your browser testing strategy.\n\nIf you want to suppress this error in testmode until December, you can add:\n  Stripe.acknowledgeIE9Deprecation = true\nbefore you call Stripe.setPublishableKey", f && console.warn(c), new Error(c)
            ...
            var c, d, e, f, g;
            for (d = !1, g = this._allowedCustomHeaders, e = 0, f = g.length; e < f; e++) if (c = g[e], c === a) {
                this._customHeaders[a] = b, d = !0;
                break
            }
            return d
        }, a.trackPerf = !1, a._isChannel = "#__stripe_transport__" === ("undefined" != typeof window && null !== window ? window.location.hash : void 0), a._isSafeStripeDomain = i, a._iframeOnAmount = 1, a._isSafeDomain = function () {
        ...
        }(), a._finalTransport = "undefined" != typeof window && null !== window && "XMLHttpRequest" in window && "withCredentials" in new XMLHttpRequest ? "cors" : "jsonp", a._transport = a._isChannel || a._isSafeDomain ? a._finalTransport : "iframe", a._fallBackToOldStripeJsTechniques = function (a) {
            return null == a && (a = !1), a && (this._finalTransport = "jsonp"), this._transport = this._finalTransport, this._isSafeDomain = "true"
        ...
        }, a._iframeBaseUrl = g, a._stripejsBaseUrl = o, a._relayResponse = function (b, c, d) {
        ...
        if (3 !== this.Stripe.version) return !f || this.Stripe.isDoubleLoaded || this.Stripe.earlyError || console.warn("It looks like Stripe.js was loaded more than one time. Please only load it once per page."), void (this.Stripe.isDoubleLoaded = !0);
    ...
    for (this.Stripe = a, this.Stripe.token = function () {
        ...
        return s(c, b), c.tokenName = "card", c.whitelistedAttrs = ["number", "cvc", "exp", "exp_month", "exp_year", "name", "address_line1", "address_line2", "address_city", "address_state", "address_zip", "address_country", "currency"], c.createToken = function (b, d, f) {
            var g, h, i;
            if (null == d && (d = {}), a.token.validate(b, "card"), "function" == typeof d ? (f = d, d = {}) : "object" != typeof d && (g = parseInt(d, 10), d = {}, g > 0 && (d.amount = g)), b._fields && b.createToken) return b.createToken(f);
            d[c.tokenName] = a.token.formatData(b, c.whitelistedAttrs), d.time_on_page = Math.round(e() - n);
            try {
                i = Object.keys(l), i.length > 0 && (d.pasted_fields = i.sort().join(","))
            } catch (j) {
                h = j
            }
            return d = a.utils.addAdditionalParams(d), a.token.create(d, f)
            ...
            var d, e, f, g;
            if (null != c) f = a.utils.trim(b), c = a.utils.trim(c); else {
                try {
        ...
        return s(c, b), c.tokenName = "bank_account", c.whitelistedAttrs = ["country", "currency", "routing_number", "account_number", "name", "account_holder_type", "account_holder_name"], c.createToken = function (b, d, e) {
        ...
        return s(c, b), c.tokenName = "pii", c.whitelistedAttrs = ["personal_id_number"], c.createToken = function (b, d, e) {
        ...
        return s(c, b), c._whitelistedAttrs = ["amount", "currency", "email", "description"], c.createReceiver = function (b, c) {
            var d;
        ...
        return s(c, b), c.stripeAccount = null, c.create = function (b, c) {
            var d, e;
            return a.token.validate(b, "source data"), d = a.token.formatData(b, this._whitelistedAttrs), d.key = a.key || a.publishableKey, a.utils.validateKey(d.key), d = a.utils.addAdditionalParams(d), e = {
                ...
                timeout: 4e4,
                headers: a.source.stripeAccount ? {"Stripe-Account": a.source.stripeAccount} : {}
    ...
    }(), d = ["createToken", "getToken", "cardType", "validateExpiry", "validateCVC", "validateCardNumber"], p = 0, q = d.length; p < q; p++) j = d[p], this.Stripe[j] = this.Stripe.card[j];
    if (this.Stripe.stripejs_ua = "stripe.js/9dc17ab", !this.Stripe._isChannel && true) try {
        "function" == typeof window.addEventListener && window.addEventListener("message", function (b) {
            var c, d;
            if (null == a.StripeV3 && !a.isDoubleLoaded) {
                ...
                return "m" === (null != c ? c.originatingScript : void 0) && /stripe\.com$/.test(b.origin) ? a.__sid = c.payload : void 0
            }
        }, !1), k = !1, b = function () {
            var b, c, d, e, f, g, h, j, l, m, n, o, p, q, r, s;
            try {
                if (null != a.StripeV3 || a.isDoubleLoaded || k) return;
                k = !0, q = document.location.href, l = null;
                try {
                    if (j = document.querySelector("meta[name=referrer]"), null != j) switch (l = null != (s = j.content) ? s.toLowerCase() : void 0) {
                        case"origin":
                        case"strict-origin":
                        case"origin-when-cross-origin":
                        case"strict-origin-when-cross-origin":
                            q = document.location.origin;
                            break;
                        case"unsafe-url":
                            q = null != q ? q.split("#")[0] : void 0
                    }
                } catch (t) {
                    b = t
                }
                f = /checkout\.stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0), c = {
                    ...
                    preview: i && !f
                }, null != l && (c.metaReferrerPolicy = l), e = "#";
                for (m in c) r = c[m], e += "" + m + "=" + encodeURIComponent(r) + "&";
                h = document.createElement("iframe"), h.src = "https://js.stripe.com/v2/m/outer.html" + e, h.style.cssText = "width: 1px !important; height: 1px !important;\nposition: fixed !important; visibility: hidden !important;\npointer-events: none !important", h.setAttribute("frameborder", "0"), h.setAttribute("allowTransparency", "true"), h.setAttribute("scrolling", "no"), h.setAttribute("tabIndex", "-1"), h.setAttribute("aria-hidden", "true"), document.body.appendChild(h), n = window.location.href, setInterval(function () {
                    var c, d;
                    if (c = window.location.href, c !== n) {
                        try {
                            d = JSON.stringify({
                                action: "ping",
                                sid: a.utils.getSessionID(),
                ...
                b = t, a.reportError("FailedMFrameLoad")
            }
        ...
        "function" == typeof document.addEventListener && document.addEventListener("paste", function (b) {
            ...
            try {
                if (c = {
                    ...
                    "postal-code": "zip",
                    zip: "zip"
                }, d = c[b.target.autocomplete] || a.utils.typeOfString(b.clipboardData.getData("text/plain"))) return l[d] = !0
            } catch (e) {
                b = e
            }
        })
    ...
    this.Stripe.isDoubleLoaded || function (a) {
        function b(a, e) {
            ...
            var g = a.Number || d.Number, h = a.String || d.String, i = a.Object || d.Object, j = a.Date || d.Date,
                k = a.SyntaxError || d.SyntaxError, l = a.TypeError || d.TypeError, m = a.Math || d.Math,
                n = a.JSON || d.JSON;
            ...
            if (!f("json")) {
                ...
                if (!t) var C = m.floor, D = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
                    E = function (a, b) {
    ...
    this.Stripe.isDoubleLoaded || !function (a, b, c, d, e, f) {
        ...
        var w, x, y, z, A, B = this, C = Math.floor(1e6 * Math.random()),
            D = (Function.prototype, /^((http:|https:|file:|chrome\-extension:|chrome:)\/\/([^:\/\s]+)(:\d+)*)/),
            E = /[\-\w]+\/\.\.\//, F = /([^:])\/\//g, G = "Stripe", H = {}, I = "stripeXDM_", J = !1;
    ...
    var a, b = [].slice, c = [].indexOf || function (a) {
    ...
    this.Stripe.isDoubleLoaded || (a = function () {
        function a(a, b, f, g) {
            ...
            for (i = function (a) {
                return function (b) {
                    var c;
                    return c = (null != b ? b.error : void 0) || {message: "Something went wrong validating your Apple Pay Session."}, null != c.message && console.warn(c.message), a.session.abort(), "function" == typeof f ? f(c) : void 0
                }
            ...
            this.addEventListener("shippingmethodselected", function (a) {
                ...
                return function (c) {
                    ...
                    return d = {
                        ...
                        headers: Stripe.applePay.stripeAccount ? {"Stripe-Account": Stripe.applePay.stripeAccount} : {},
                        data: {
    ...
    this.Stripe.isDoubleLoaded || (this.Stripe.utils = function () {
        ...
        return c = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, b.trim = function (a) {
            ...
            var d, e, f;
            return null == c && (c = {}), e = new Date, f = c.expiresIn || 31536e6, e.setTime(e.getTime() + f), null == c.path && (c.path = "/"), b = (b + "").replace(/[^!#-+\--:<-\[\]-~]/g, encodeURIComponent), d = "" + encodeURIComponent(a) + "=" + b + ";expires=" + e.toGMTString() + ";path=" + c.path, c.domain && (d += ";domain=" + c.domain), document.cookie = d
        }, b.getCookie = function (a) {
            var b, c, d, e, f, g, h;
            for (c = document.cookie.split("; "), g = 0, h = c.length; g < h; g++) if (b = c[g], d = b.indexOf("="), e = decodeURIComponent(b.substr(0, d)), f = decodeURIComponent(b.substr(d + 1)), e === a) return f;
            return null
        }, b.getMerchantID = function () {
            var a, b;
            try {
                return b = this.getCookie("__stripe_mid") || this.generateID(), this.setCookie("__stripe_mid", b, {domain: "." + document.location.hostname}), b
            } catch (c) {
                return a = c, "NA"
            }
    ...
    var a, b, c = [].slice;
    b = (new Date).getTime(), a = !1, this.Stripe.isDoubleLoaded || (this.Stripe.ajaxJSONP = function (d) {
        var e, f, g, h, i, j, k, l;
        return null == d && (d = {}), g = "sjsonp" + ++b, j = document.createElement("script"), f = null, e = function (a) {
            var b;
            return null == a && (a = "abort"), clearTimeout(f), null != (b = j.parentNode) && b.removeChild(j), g in window && (window[g] = function () {
            }), "function" == typeof d.complete ? d.complete(a, l, d) : void 0
        }, l = {abort: e}, null == a ? void l.abort() : (j.onerror = function () {
            return l.abort(), "function" == typeof d.error ? d.error(l, d) : void 0
        }, window[g] = function () {
            var a, b;
            a = 1 <= arguments.length ? c.call(arguments, 0) : [], clearTimeout(f), j.parentNode.removeChild(j);
            try {
                delete window[g]
            } catch (e) {
                b = e, window[g] = void 0
            }
            return "function" == typeof d.success && d.success.apply(d, c.call(a).concat([l])), "function" == typeof d.complete ? d.complete("success", l, d) : void 0
        }, i = (d.headers || {})["Accept-Language"], k = (d.headers || {})["Stripe-Account"], d.data || (d.data = {}), d.data.callback = g, d.method && (d.data._method = d.method), i && (d.data._accept_language = i), k && (d.data._stripe_account = k), j.src = d.url + "?" + Stripe.utils.serialize(d.data), h = document.getElementsByTagName("head")[0], h.appendChild(j), d.timeout > 0 && (f = setTimeout(function () {
    ...
    this.Stripe.isDoubleLoaded || (b = {
        ...
        return this.url = a.url, this.timeout = null, this._successHandler = function () {
            ...
            return function (b, c) {
                ...
                return Stripe.reportError(c), Stripe._fallBackToOldStripeJsTechniques(!0), Stripe.request(a.o, !0)
            }
    ...
    this.Stripe.isDoubleLoaded || (a = function (a) {
        ...
        onLoad: function () {
            return this._socketLoadTime = +new Date, this.onError = function () {
                ...
                return function () {
                    ...
                    }, clearTimeout(a.loadTimeout), d("AckTimeoutError")
                }
        ...
        onError: function () {
            ...
            }, clearTimeout(this.ackTimeout), clearTimeout(this.injectTimeout), clearTimeout(this.loadTimeout), d("IframeOnError")
        },
        onInternalError: function (a) {
            ...
            }, clearTimeout(this.ackTimeout), clearTimeout(this.loadTimeout), clearTimeout(this.injectTimeout), Stripe.reportError("FB-XDM-" + a), Stripe._fallBackToOldStripeJsTechniques(), d = Stripe._iframePendingRequests;
            for (b in d) e.call(d, b) && (c = d[b], Stripe._callCache[c.requestId] = function () {
        ...
        onAsyncInject: function (a) {
            return this.injectTimeout = setTimeout(function (a) {
                return function () {
                    ...
                    }, clearTimeout(a.ackTimeout), clearTimeout(a.loadTimeout), d("InjectTimeoutError")
                }
            }(this), this.ackTimeoutDuration)
        },
    ...
    this.Stripe.isDoubleLoaded || (this.Stripe.validator = {
        "boolean": function (a, b) {
            ...
            if (h = {CA: ["Tax ID", [/^\d{9}$/]], US: ["EIN", [/^\d{2}-?\d{7}$/]]}, g = h[a], null != g) {
                for (c = g[0], f = g[1], d = !1, i = 0, j = f.length; i < j; i++) if (e = f[i], e.test(b)) {
                    d = !0;
                    break
                }
